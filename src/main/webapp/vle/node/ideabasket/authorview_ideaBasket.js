 ...
 * TODO: rename TemplateNode
 */
View.prototype.IdeaBasketNode.commonComponents = [];
 ...
 * TODO: rename TemplateNode
 */
View.prototype.IdeaBasketNode.generatePage = function(view){
	this.view = view;
	 ...
	 */
	var promptTextArea = createElement(document, 'textarea', {id: 'promptTextArea', rows:'20', cols:'85', onkeyup:"eventManager.fire('ideaBasketUpdatePrompt')"});
 ...
 * TODO: rename TemplateNode
 */
View.prototype.IdeaBasketNode.getCommonComponents = function() {
 ...
 * TODO: rename TemplateNode
 */
View.prototype.IdeaBasketNode.updateContent = function(){
 ...
 * TODO: rename TemplateNode
 */
View.prototype.IdeaBasketNode.populatePrompt = function() {
 ...
 * TODO: rename TemplateNode
 */
View.prototype.IdeaBasketNode.updatePrompt = function(){
	/* update content */
...
if(typeof eventManager != 'undefined'){
	 ...
	 */
	eventManager.fire('scriptLoaded', 'vle/node/ideabasket/authorview_ideaBasket.js');
};